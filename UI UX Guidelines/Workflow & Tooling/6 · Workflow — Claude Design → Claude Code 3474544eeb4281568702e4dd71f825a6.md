...
- **Briefs** (ch. 1) → **Claude Design** generates against your onboarded system (ch. 2 + BRANDBOOK.md) → reviewers refine against state matrices (ch. 4) and visual proof (ch. 3) → **handoff to Claude Code** for implementation (ch. 5) → frames **mirrored back** into the Figma library.
